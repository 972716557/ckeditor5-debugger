...
export {
	...
	type TransformOperationSetsResult,
...
export {
	ModelLivePosition,
	type ModelLivePositionChangeEvent,
} from './model/liveposition.js';
...
export {
	ViewDataTransfer,
	type ViewDropEffect,
	type ViewEffectAllowed,
} from './view/datatransfer.js';
export {
	ViewDomConverter,
	type ViewBlockFillerMode,
} from './view/domconverter.js';
...
export {
	ViewDocument,
	type ViewDocumentPostFixer,
	type ViewDocumentChangeType,
} from './view/document.js';
...
} from './view/elementdefinition.js';
export {
	ViewDocumentSelection,
	type ViewDocumentSelectionChangeEvent,
} from './view/documentselection.js';
...
} from './view/observer/observer.js';
...
export {
	CompositionObserver,
	type ViewDocumentCompositionEventData,
...
export {
	BubblingEventInfo,
	type BubblingEventPhase,
} from './view/observer/bubblingeventinfo.js';
